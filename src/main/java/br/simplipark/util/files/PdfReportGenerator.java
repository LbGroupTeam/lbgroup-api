...
import br.simplipark.user.reporting.HistoricalChargingData;
import br.simplipark.user.reporting.ReportData;
import br.simplipark.user.reporting.SummedUpReportData;
...
import static br.simplipark.util.FormatingUtils.roundToTwoDecimals;
